...
@Component({
  ...
  templateUrl: './registrar-editar-producto-solicitud-perzonalizada.component.html',
  styleUrls: ['./registrar-editar-producto-solicitud-perzonalizada.component.css']
})
export class RegistrarEditarProductoSolicitudPerzonalizadaComponent implements OnInit {
