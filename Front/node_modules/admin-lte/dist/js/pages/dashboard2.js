...
// function mensaje() {
//     if (document.getElementById('puntos').textContent - document.getElementById('valoruleta').textContent) {
...
function mensaje() {
    var valor_ruleta = parseInt(document.getElementById('valoruleta').innerHTML);
    var puntos_usuario = parseInt(document.getElementById('puntos').innerHTML);
    if (puntos_usuario < valor_ruleta) {
        document.getElementById('iniciar').style.display = "None";
        document.getElementById('mensaje').style.display = "block";
    }
...
function Parar() {
    ...
    document.getElementById("rueda").className = "rueda2";
    clearInterval(temporizador);
    if (document.getElementById("porcentaje").textContent == "0") {
        document.getElementById("textoicon").className = "text-danger";
        document.getElementById("textoicon").style.display = "block";
        document.getElementById("icon_mensaje").className = "bi bi-x-circle-fill";
...
function Iniciar() {
    document.getElementById("textoicon").style.display = "none";
