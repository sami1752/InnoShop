...
function rotate(value) {
    var soli = document.getElementById("flecha");
    if (soli.style.msTransform == "rotate(" + 180 + "deg)" || soli.style.webkitTransform == "rotate(" + 180 + "deg)" || soli.style.transform == "rotate(" + 180 + "deg)") {
        document.getElementById('flecha').style.webkitTransform = "rotate(" + 0 + "deg)";
        document.getElementById('flecha').style.msTransform = "rotate(" + 0 + "deg)";
        document.getElementById('flecha').style.transform = "rotate(" + 0 + "deg)";
    } else {
        document.getElementById('flecha').style.webkitTransform = "rotate(" + value + "deg)";
        document.getElementById('flecha').style.msTransform = "rotate(" + value + "deg)";
        document.getElementById('flecha').style.transform = "rotate(" + value + "deg)";
    }
