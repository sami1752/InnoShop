...
namespace Back.Models.Servicios
{
    public class ServiciosVentas : IServiciosVentas
    {
           ...
           await using (_context)
            {
                List<DetalleVenta> listaVentas = (from venta in _context.Ventas
                                                  ...
                                                  on descuento.IdPorcentajeRuleta equals porcentaje.Porcentaje
                                                  ...
                                                  select new DetalleVenta
                                                  {
                                                      ...
                                                      TotalIva = venta.Total * iva.Porcentaje / 100,
        ...
        public async Task<ActionResult<IEnumerable<DetalleVentaProductos>>> ListarDetalleVentaProductos(int idVenta) =>
            await _context.DetalleVentaProductos.Where(x => x.IdVenta == idVenta).ToListAsync();
        ...
        public async Task AgregarDetalleVentaProducto(DetalleVentaProductos detalle)
        {
            ...
            venta.TotalIva += precio.Precio * (iva.Porcentaje / 100);
            venta.Total += detalle.Cantidad * precio.Precio;
